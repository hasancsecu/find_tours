      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'You Have Succcessfully Logged In!');
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'You Have Succcessfully Logged Out');
            window.setTimeout(function () {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'You have Succcessfully Signed Up! Please Check Your Email to Activate Your Account');
            window.setTimeout(function () {
      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alert.showAlert)('success', 'Data is Successfully Updated!');
          }
      ...
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alert.showAlert)('success', 'Password is Successfully Updated!');
          }
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Token Successfully Sent to Your Email');
            window.setTimeout(function () {
              location.reload(true);
            }, 4000);
          }
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'You Have Successfully Reset Your Password!');
            window.setTimeout(function () {
              location.assign('/login');
            }, 3000);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addReview.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var addreview = function addreview(rating, review, tourId) {
  var res;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your Review is Succcessfully Added! Thank You For Your Feedback.');
            window.setTimeout(function () {
              location.assign("/tours/".concat(tourId));
            }, 3000);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"confirmAccount.js":[function(require,module,exports) {
"use strict";
...
var confirmAccount = function confirmAccount(confirmCode, userId) {
  var code, res;
  return regeneratorRuntime.async(function confirmAccount$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          code = window.location.href.split('/')[5];
          _context.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
            url: "/api/v1/users/confirmAccount/".concat(userId, "/").concat(code),
            data: {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Account Confirmation Successful!');
            window.setTimeout(function () {
              location.assign('/login');
            }, 4000);
          }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"paginate.js":[function(require,module,exports) {
"use strict";
...
var searchResultPage = document.querySelector('.results__pages');

var renderTours = function renderTours(tour) {
  var markup = "\n    .card__header\n    .card__picture\n        .card__picture-overlay &nbsp;\n        img.card__picture-img(src='/img/tours/".concat(tour.imageCover, "', alt='").concat(tour.name, "')\n    h3.heading-tertirary\n        span= tour.name\n    .card__details\n        h4.card__sub-heading= '").concat(tour.difficulty, " ").concat(tour.duration, "-day tour'\n        p.card__text= tour.summary\n        .card__data\n            svg.card__icon\n                use(xlink:href='/img/icons.svg#icon-map-pin')\n            span= tour.startLocation.description\n    .card__data\n        svg.card__icon\n            use(xlink:href='/img/icons.svg#icon-calendar')\n        span= tour.startDates[0].toLocaleString('en-us',{month:'long',year:'numeric'})\n    .card__data\n        svg.card__icon\n            use(xlink:href='/img/icons.svg#icon-flag')\n        span= '").concat(tour.locations.length, " stops'\n    .card__data\n        svg.card__icon\n            use(xlink:href='/img/icons.svg#icon-user')\n        span= '").concat(tour.maxGroupSize, " people'\n\n    .card__footer\n        p\n            span.card__footer-value= '$").concat(tour.price, "'\n            span.card__footer-text  per person\n        p.card__ratings\n            span.card__footer-value= tour.ratingsAverage\n            span.card__footer-text= rating (").concat(tour.ratingsQuantity, ")\n        a.btn.btn--green.btn--small(href='/tours/").concat(tour._id, "') Details\n        ");
};

var createButton = function createButton(page, type) {
  return "\n        button(class=\"btn-inline results__btn--".concat(type, "\" data-goto=").concat(type == 'prev' ? page - 1 : page + 1, ")\n            span Page ").concat(type == 'prev' ? page - 1 : page + 1, "\n            svg.search__icon\n                use(href=\"img/icons.svg#icon-triangle-").concat(type == 'prev' ? 'left' : 'right', "\")   \n");
};
...
var renderResult = function renderResult(tours) {
  ...
  tours.slice(start, end).forEach(renderTours); //render pagination createButton
...
var _confirmAccount = require("./confirmAccount");

var _paginate = require("./paginate");

// DOM Elements
var mapBox = document.getElementById('map');
var logInForm = document.getElementById('btnLog');
var signUpform = document.getElementById('btnSign');
var logOutBtn = document.querySelector('.nav__el--logout');
var updateSettings = document.getElementById('btnUpdateData');
var updateUserPassword = document.getElementById('btnUpdatePassword');
var forgotPasswordBtn = document.getElementById('forgotPasswordBtn');
var resetPasswordBtn = document.getElementById('btnResetPassword');
var bookTourBtn = document.getElementById('book-tour');
var addReviewBtn = document.getElementById('btnAddReview');
var confirmCodebtn = document.getElementById('confirmBtn'); // Delegation
...
if (logInForm) {
  logInForm.addEventListener('click', function _callee(e) {
    var email, password;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return regeneratorRuntime.awrap((0, _login.login)(email, password));
...
if (signUpform) {
  signUpform.addEventListener('click', function _callee2(e) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 8;
            return regeneratorRuntime.awrap((0, _signup.signup)(name, email, password, confirmPassword));
...
if (updateSettings) {
  updateSettings.addEventListener('click', function _callee3(e) {
    var form;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 7;
            return regeneratorRuntime.awrap((0, _updateSettings.updateData)(form));
...
if (updateUserPassword) {
  updateUserPassword.addEventListener('click', function _callee4(e) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 6;
            return regeneratorRuntime.awrap((0, _updateSettings.updatePassword)(password, newPassword, confirmPassword));
...
if (forgotPasswordBtn) {
  forgotPasswordBtn.addEventListener('click', function _callee5(e) {
    var email;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            email = document.getElementById('email').value;
            _context5.next = 5;
            return regeneratorRuntime.awrap((0, _forgotPassword.forgotPassword)(email));
...
if (resetPasswordBtn) {
  resetPasswordBtn.addEventListener('click', function _callee6(e) {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 6;
            return regeneratorRuntime.awrap((0, _resetPassword.resetPassword)(password, confirmPassword, token));
...
if (bookTourBtn) {
  bookTourBtn.addEventListener('click', function _callee7(e) {
    var tourId;
...
if (addReviewBtn) {
  addReviewBtn.addEventListener('click', function _callee8(e) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            tourId = window.location.href.split('/')[4];
            _context8.next = 6;
            return regeneratorRuntime.awrap((0, _addReview.addreview)(rating, review, tourId));
...
if (confirmCodebtn) {
  confirmCodebtn.addEventListener('click', function _callee9(e) {
    var code, userId;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            _context9.next = 5;
            return regeneratorRuntime.awrap((0, _confirmAccount.confirmAccount)(code, userId));
